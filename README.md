# Proyecto Ultra V7.20

## Cambios V7.20

- El jugador se llama Pitiao y su nombre reemplaza “Tú” sobre el personaje y en el mapa.
- Nombres humanos elevados y tres barras compactas sobre el jugador: vida, maná y aguante.
- Inicio con ropa, espada, escudo, 500 de oro, 200 vendas y 3 pociones.
- Impulso de recuperación de +10% de velocidad durante 5 minutos tras reaparecer; termina al recuperar el cadáver.
- Las vendas se aplican en 0,5 s y dejan 0,5 s de recarga.
- Inicio sin hechizos. Se requiere un grimorio equipado, pergaminos aprendidos y favoritos elegidos desde el libro.
- Doce hechizos progresivos; Portal y la teletransportación fueron retirados.
- Los pergaminos escalan con el peligro del enemigo y también se venden en el catálogo arcano.
- Todas las minas tienen una forja funcional y no contienen NPC.
- Guardias con armadura, armas cuerpo a cuerpo variables y habilidades físicas en 100.
- Paletas diferenciadas por familia y material en equipo, inventario, paperdoll y armas visibles.

## Cambios V7.19

- Audio procedural para movimiento, combate, magia, recolección, fabricación, equipo, loot, comercio, banco, curación, muerte, reaparición, guardado y carga.
- Control de volumen y opción de silenciar en Ajustes.
- Minería y Tala entrenan Fuerza al iniciar una recolección válida.
- Inicio con ropa básica, espada de hierro y escudo equipados, más 500 de oro.
- Sin armas, armaduras, consumibles ni recursos gratuitos adicionales al comenzar.
- Guantes y mangas visibles correctamente en ambos perfiles.
- Eliminado el aro de selección duplicado; se conserva únicamente el alineado con la sombra.

## Cambios V7.18

- Mapa ampliado de 280 a 480 unidades y nueva Cantera de Valdoria junto a la ciudad.
- Murallas completas alrededor de las ciudades con accesos norte, sur, este y oeste.
- Árboles, pasto y rocas procedurales según el bioma.
- Fauna, no muertos, monstruos y humanoides distribuidos en hábitats separados.
- Distancia mínima de aparición para evitar amontonamientos.
- Respawn de enemigos aumentado de 2 a 4 minutos.
- Probabilidad sistémica mínima de 10% de equipo útil: armaduras, armas, anillos y collares.
- La fuerza, variante y jefatura del enemigo mejoran rareza, cantidad de propiedades y rangos.
- Armas épicas con brillo tenue; legendarias con brillo mayor y pulsante.
- Nombres elevados, selección alineada con la sombra, avisos a la izquierda y paperdoll ampliado.

## Cambios V7.17

### Integración gráfica desde index(37) y Westeros V5
- Nuevo renderer humano construido exclusivamente con primitivas de HTML Canvas.
- Rig común para cabeza, torso, hombros, brazos, manos, cadera, rodillas y pies.
- Armadura emparentada a las articulaciones: brazales, guantes, grebas y botas siguen la pose.
- Jerarquías direccionales oficiales:
  - Frente: capa y pelo posterior detrás del cuerpo.
  - Espalda: la capa cruza por delante del cuerpo y las extremidades.
  - Perfiles: capa, melena y escudo forman correctamente la silueta posterior.
- Casco unificado en las cuatro direcciones.
- Capa con broche independiente y movimiento ligado a cada animación.
- Armas ancladas al centro de la mano.
- Siluetas propias para espada, mandoble, daga, maza, gran maza, hacha, gran hacha, lanza, pica, arco y báculo.
- Los metales del arma y del escudo responden al material realmente equipado.
- Animaciones de reposo, caminar, ataque, canalización, impacto y muerte trasladadas al rig nuevo.
- El renderer anterior se conserva como respaldo para animales y monstruos, evitando regresiones en criaturas.
- Integración aplicada tanto al mundo como al personaje visible del inventario.
