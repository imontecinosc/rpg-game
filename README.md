# Proyecto Ultra — Core modular

Esta entrega reorganiza el proyecto sin cambiar deliberadamente el HUD ni el gameplay.

- Abrir `index.html` mediante GitHub Pages o un servidor local.
- Arquitectura: `docs/ARCHITECTURE.md`.
- Estado de migración: `docs/MIGRATION_STATUS.md`.

> Para módulos ES tradicionales cargados por `<script>`, no es obligatorio compilar ni instalar dependencias.

---

## README anterior (referencia histórica)
