...
const SAVE_KEY = "proyecto_ultra_v4_5_2";
const LEGACY_SAVE_KEYS=["proyecto_ultra_v4_5_1","proyecto_ultra_v4_5","proyecto_ultra_v4_4","proyecto_ultra_v4_3","proyecto_ultra_v4_2","proyecto_ultra_v4_1","proyecto_ultra_v4"];
...
// La pantalla de equipo siempre inicia con avatar y slots visibles.
const openEquipmentV452Base=openEquipment;
openEquipment=function(){
 openEquipmentV452Base();
 requestAnimationFrame(()=>{
  normalizeEquipmentSlotLabels();
  ensurePaperDollVisible();
 })
