(function (U) {
  ...
  function label(o, p, isPlayer = false) {
    ...
    const nameY =
      p.y -
      (isPlayer ? 87 : o.boss ? 96 : o.variant === 'exalted' ? 88 : o.variant === 'renowned' ? 81 : 77);
  ...
  U.draw = function () {
    ...
    if (U.player.target && !U.player.target.dead) {
      ...
      c.lineWidth = 3;
      const targetIsHumanoid = ['guard', 'vendor', 'banker', 'healer', 'bandit', 'zombie', 'skeleton'].includes(
        U.player.target.type,
      );
      c.beginPath();
