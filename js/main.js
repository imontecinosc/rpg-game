(function(U){
  try{
    ...
    U.addItem('gold',10000);U.addItem('bandage',20);U.addItem('potion',8);U.addItem('manaPotion',3);U.addItem('ironSword');U.addItem('greatSword');U.addItem('spear');U.addItem('bow');U.addItem('mace');U.addItem('gauntlets');U.addItem('shield');
    ...
    U.bindInput();U.ui.bind();U.ui.refreshAll();U.last=performance.now();requestAnimationFrame(U.loop);U.toast('V7.0 cargada. Mina Escuela y combate visual renovado.');
