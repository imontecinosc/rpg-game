(function (U) {
  try {
    U.initCanvas();
    U.setupWorld();
    U.addItem('gold', 10000);
    U.addItem('bandage', 20);
    U.addItem('potion', 8);
    U.addItem('manaPotion', 3);
    U.addItem('ironSword');
    U.addItem('greatSword');
    U.addItem('spear');
    U.addItem('bow');
    U.addItem('mace');
    U.addItem('gauntlets');
    ...
    U.toast('V7.8 cargada. Notables y Exaltados acechan el mundo.');
  } catch (err) {
    console.error(err);
