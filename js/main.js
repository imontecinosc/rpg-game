(function(U){
  try{
    ...
    U.bindInput();U.ui.bind();U.ui.refreshAll();U.last=performance.now();requestAnimationFrame(U.loop);U.toast('V6.0 cargada. Vendedores especializados y objetos por material disponibles.');
