(function (U) {
  ...
  U.skillPractice = {};
  /* FIX jugabilidad: las skills y stats subían al doble de la velocidad
     pedida. GLOBAL_RATE aplica la mitad exacta sobre TODO lo que entrena,
     sin tener que tocar cada llamada de raiseSkill/raiseStat una por una. */
  ...
  /* Vendaje aleatorio 1.5-4.0s, ponderado por Curar+Destreza sin ser
     determinístico (ver ronda anterior). Sube Destreza y Anatomía. */
