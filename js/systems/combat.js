(function (U) {
  ...
  const defs = {
    ...
    veilKeeper: {
      ...
      danger: 8,
      loot: [
        // Legendario exclusivo de este jefe.
        ['veilShroud', 0.06],
        ['gold', 1],
        ['veilEssence', 1],
        ['veilCloak', 0.32],
    ...
    boss: {
      ...
      danger: 8,
      loot: [
        // Legendarios: el Filo es exclusivo, y el Anillo del depredador
        // existia en el catalogo pero no lo soltaba nadie.
        ['umbralEdge', 0.05],
        ['ringLeech', 0.04],
        ['contract110', 0.45],
        ['contract115', 0.18],
  ...
  U.killEnemy = function (t) {
    ...
    const scrollPool = [
      'scrollSpark', 'scrollMend', 'scrollIce', 'scrollFire', 'scrollWard', 'scrollCurse',
