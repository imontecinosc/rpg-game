(function (U) {
  U.setupWorld = function () {
    ...
    /* FIX jugabilidad: esta zona quedaba centrada EXACTAMENTE sobre la mina
       de la misión (108,-8), donde están el capataz Dagan y el Capitán de
       Hierrogris. Bandidos regulares del mundo se mezclaban con el
       encuentro de la misión y no se podía completar con calma. Se movió
       a una zona despejada, lejos de cualquier otro spawn o de la misión. */
